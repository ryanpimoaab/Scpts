...
awk '!/.at$|.bid$|.cn$|.kim$|.li$|.link$|.pw$|.review$|.ro$|.ru$|.su$|.tk$|.top$|.ua$|.ve$|.work$|.ch$|.lol$|.v$|.w$|.loan$|.click$/ {print}' /Volumes/Rayyan/Pi/Github/Scrpts/Lists/SB-hsts.txt > tmp && mv tmp /Volumes/Rayyan/Pi/Github/Scrpts/Lists/SB-hsts.txt
